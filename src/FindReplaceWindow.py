...
class FindReplaceWindow(wx.Frame):
    def __init__(self, project, notebook):
        ...
        findLbl = wx.StaticText(parent=panel, label="Find Text:")
        self.FindText = wx.TextCtrl(parent=panel)
        replaceLbl = wx.StaticText(parent=panel, label="Replace with:")
        self.ReplaceText = wx.TextCtrl(parent=panel)
        self.InFileCheck = wx.RadioButton(parent=panel, label="Search in File")
        self.AllFilesCheck = wx.RadioButton(parent=panel, label="Search All Files in Project")
        self.AllFilesCheck.Bind(wx.EVT_RADIOBUTTON, self.OptionChecked)
        self.InFileCheck.Bind(wx.EVT_RADIOBUTTON, self.OptionChecked)
        self.OnlyInStrings = wx.CheckBox(parent=panel, label="Search Only in Strings")
        self.CaseSensitive = wx.CheckBox(parent=panel, label="Case Sensitive Search")
        self.FindButton = wx.Button(parent=panel)
        ...
        self.ReplaceButton = wx.Button(parent=panel)
        ...
        self.ReplaceFileButton = wx.Button(parent=panel)
        ...
        self.CloseButton = wx.Button(parent=panel)
